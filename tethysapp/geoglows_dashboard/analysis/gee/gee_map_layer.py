...
class GEEMapLayer:
    ...
    def SpiSmaller12(summedChirpsCollection):
        ...
        def calculate_stats(toStats):
            ...
            collectionForStats = summedChirpsCollection \
    ...
    def main(self):
        ...
        def calculate_precipitation_sum(monthly_sum):
            ...
            time = ee.Date(summedCollection.get('system:time_end')) \
                .difference(ee.Date(summedCollection.get('system:time_start')), 'month').round()
