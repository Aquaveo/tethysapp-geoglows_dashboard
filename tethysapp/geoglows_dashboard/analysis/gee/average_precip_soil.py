...
class AveragePrecipitationAndSoilMoisture:
    def __init__(self, area): # TODO area is always a Polygon?
    ...
    def get_data(self):
        ...
        return gldas_avg_df, cum_df_gldas


    def plot_data(self, gldas_avg_df, cum_df_gldas):
    ...
    def run(self):
        figure = self.plot_data(*self.get_data())
        return offline_plot(
            figure,
